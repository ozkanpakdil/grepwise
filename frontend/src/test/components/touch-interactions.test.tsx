...
describe('Touch Interactions', () => {
  ...
  test('WidgetRenderer has swipe handlers attached', () => {
    render(<WidgetRenderer widget={mockWidget} />);
    
    // Check if the widget renderer has the swipe handlers attached
    const widgetRenderer = screen.getByText('Test Widget').closest('.widget-renderer');
    expect(widgetRenderer).toHaveAttribute('data-swipeable', 'true');
  });
