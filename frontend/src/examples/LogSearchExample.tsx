...
import type { LogEntry } from '../generated/logservice_pb';
  ...
  return (
    <div className="p-4">
      ...
      <div>
        ...
        {logs.length > 0 && (
          <p className="mb-2">
            Showing {logs.length} of {totalResults} results (Page {currentPage + 1} of {totalPages})
          </p>
        )}
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border">
              ...
              <tbody>
                {logs.map((log) => (
                  <tr key={log.getId()}>
                    <td className="px-4 py-2 border">{formatTimestamp(log.getTimestamp())}</td>
